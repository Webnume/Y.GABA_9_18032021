          ...
          <form data-testid="form-new-bill">
            <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="hideErrorMessage" id="errorFileType" data-testid="errorFile">Fichier non autorisé. Seuls les fichiers avec une extension jpg, jpeg ou png sont acceptés</div>
                </div>
            </div>
            <div class="row">
              <div class="col-md-6">
